 ...
 <input type="hidden" name="mini_birth" id="mini_birth" value="<?php echo $mini_birth; ?>"/>
   <?php if($user_setting){ ?>   
    <div class="stepwizard-row setup-panel">	   
          ...
          <div class="stepwizard-step">
			<a href="javascript:void(0);" id="btndisb" type="button" class="btn btn-default btn-circle" disabled="disabled">2</a>
			<p>Step 2</p>
          </div>		
    </div>
	 <?php } ?>
  </div>
   <form role="form" action="<?php echo base_url(); ?>registration/admin" method="post">
      ...
      <div class="col-xs-12">
        <div class="col-md-12 col-xs-12">
            <input type="email" id="txtemail" class="input_form_sign d_block active_inp" placeholder="EMAIL" name="email" value=""  />
			 ...
			 <label class="error"></label>
			 <input type="hidden" name="user_type" value="admin" class="input_form_sign d_block active_inp" readonly />	
		   <?php
