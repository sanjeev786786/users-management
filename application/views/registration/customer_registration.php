<div class="cont_principal">
 ...
 <input type="hidden" name="psd_len" id="psd_len" value="<?php echo $password_length; ?>"/>
  ...
  <?php if($user_setting){ ?>
   ...
   <form role="form" action="<?php echo base_url(); ?>registration/customer" method="post">
    <div class="row setup-content" id="step-1">
      <div class="col-xs-12">
        <div class="col-md-12 col-xs-12">
			...
			<label class="error"></label>
			<input type="hidden" name="user_type" value="customer" class="input_form_sign d_block active_inp"  readonly />
