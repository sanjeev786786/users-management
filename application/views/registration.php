<div class="cont_principal">
 ...
 <div class="stepwizard col-md-offset-3">
   ...
   <form role="form" action="<?php echo base_url(); ?>registration/sign_up" method="post">
    <div class="row setup-content" id="step-1">
      <div class="col-xs-12">
        <div class="col-md-12 col-xs-12">
			...
			<label class="error"></label>
           <select id="user_type" class="input_form_sign d_block  active_inp tyle_add" name="user_type" >
	  ...
	  <?php } ?>
			...
			<div class="cont_btn">
				...
				<input type="submit" value="Submit" class="stp1_submit btn_sign">
			 </div> 							
              <a href="<?php echo base_url(); ?>index.php/account" class="link_forgot_pass d_block lef" >Login</a>
...
function show(city){
	$.ajax({
	type: "POST",
	url: "<?php echo base_url(); ?>index.php/registration/pop_district_data",
...
function showUser(str)
{
	...
	$.ajax({
	type: "POST",
	url: "<?php echo base_url(); ?>index.php/registration/ajax_call_pop_district_data",
	data:'q='+str,
	success: function(data){
   ...
   $(document).ready(function(){
		  ...
		  var sEmail = $('#txtemail').val();
           ...
           if (($.trim(sEmail).length == 0) || (!filter.test(sEmail))) {
			...
			return false;
				...
				$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>index.php/registration/check_email",
			data:'email='+sEmail,
			success: function(data){
	...
	$(".signup").click(function(e){
		...
		if(($('#fname_ship').val()=="") || !fship.match(name_regex)) {
		   ...
		   if(($('#lname_ship').val()=="") || !lship.match(name_regex)) {
			 $('#lname_ship').focus();
		   ...
		   if ($('input.checkbox_check').is(':checked')) {
			...
			if(($('#fname_bill').val()=="") || !fbill.match(name_regex)) {
			   ...
			   if(($('#lname_bill').val()=="") || !lbill.match(name_regex)) {
				 $('#lname_bill').focus();
